...
if ( function_exists('is_multisite') && is_multisite() ) {
	...
	foreach ($blogs as $blog_obj) {
		delete_blog_option( $blog_obj->blog_id, 'jr_rm_settings' );
		delete_blog_option( $blog_obj->blog_id, 'jr_rm_internal_settings' );
	}
} else {
	delete_option( 'jr_rm_settings' );
	delete_option( 'jr_rm_internal_settings' );
}
?>